            ...
            <div class="side-bar flex flex-col w-[300px] shrink-0 gap-10">
                <div class="ads flex flex-col gap-3 w-full">
                    ...
                    <p class="font-medium text-sm leading-[21px] text-[#A3A6AE] flex gap-1">
                        Our Advertisement <img src="{{ asset('images/icons/message-question.svg') }}" alt="icon" />
                    </p>
                </div>
                            ...
                            <div
                                ...
                                <div class="flex flex-col gap-[6px]">
                                    <p class="line-clamp-2 font-bold">
                                        {{ strlen($item_news->name) > 50 ? substr($item_news->name, 0, 70) . '...' : $item_news->name }}
                                    </p>
                                    <p class="text-xs leading-[18px] text-[#A3A6AE]">
                                        {{ $item_news->created_at->format('d M, Y') }} •
                                        {{ $item_news->category->name }}</p>
                                </div>
                            </div>
                        </a>
                    @empty
                ...
                <div class="ads flex flex-col gap-3 w-full">
                    <a href="{{ $squareAds_2->link }}">
                        <img src="{{ Storage::url($squareAds_2->thumbnail) }}" class="object-contain w-full h-full"
                            alt="ads" />
                    </a>
                    <p class="font-medium text-sm leading-[21px] text-[#A3A6AE] flex gap-1">
                            ...
                            <div
                                ...
                                <div class="thumbnail-container h-[200px] relative rounded-[20px] overflow-hidden">
                                    <div
                                        ...
                                        <p class="text-xs leading-[18px] font-bold">
